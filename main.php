...
<html>
  <head>
    ...
    <meta name="keywords" content="Ricky Primus Saputra" />
  ...
  <body class="skin-blue fixed">
    <div class="wrapper">
      ...
      <header class="main-header">
        <!-- Logo -->
        <a href="index2.html" class="logo"><b>Al'</b>Steam</a>
      ...
      <footer class="main-footer">
        <strong>Copyright &copy; 2022 - <a href="youtube.com/silucky">ricky</a>.</strong>
      </footer>
    </div><!-- ./wrapper -->
